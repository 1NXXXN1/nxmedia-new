    ...
    <div className="min-h-[500px] max-h-screen flex items-start justify-center px-4 pb-4 overflow-auto">
      <div className="w-full max-w-5xl bg-white/5 rounded-3xl shadow-2xl flex flex-col md:flex-row overflow-hidden border border-gray-800/30">
        ...
        <div className="hidden md:flex flex-col justify-center items-center w-1/2 p-12 relative">
          {/* Background image behind NX logo */}
          ...
          <div className="relative z-10 flex flex-col items-center w-full">
            ...
            <h2 className="text-2xl font-bold text-white mb-2 text-center">Регистрация</h2>
            <p className="text-blue-100 text-base text-center">Создайте новый аккаунт для просмотра фильмов и сериалов</p>
          </div>
        </div>
        {/* Right form */}
        <div className="w-full md:w-1/2 flex flex-col justify-center p-10 bg-white/10 backdrop-blur-lg">
          <h1 className="text-2xl font-extrabold mb-3 text-center text-gray-900 dark:text-white tracking-tight">Регистрация</h1>
          <p className="text-gray-500 dark:text-gray-300 text-center mb-8 text-base font-medium">Создайте новый аккаунт, чтобы продолжить</p>
          ...
          {success && (
            <div className="mb-6 p-3 bg-green-500/10 border border-green-500/30 rounded-xl text-green-500 text-base text-center font-medium">
          ...
          <form onSubmit={handleRegister} className="space-y-7">
            <div>
              <label className="block text-sm font-semibold mb-2 text-gray-800 dark:text-gray-200">Имя</label>
              <input
                type="text"
                value={displayName}
            ...
            <div>
              <label className="block text-sm font-semibold mb-2 text-gray-800 dark:text-gray-200">Подтвердите пароль</label>
              <input
                type="password"
